...
Thats it for the installation, but if you want to enhance your experience there is two more things:
...
But if you want to change it, or load a new one different, see below :), just folow this:
...
DISCLAIMER: Due to script and lua limitations there can be only 1 pack active and loaded, if you want to change be sure that you are not in flight, i recommend to do that when you are in preflight phase
            because you need to reload the script and if you do that, all your progres will be lost, the reset or turnaround point is the preflight phase.
You will see the active voice pack name in the Settings page.

///// CREATE A NEW VOICE PACK /////

Yes you can create your own voice pack, it's totally posible and easy.
...
Thats it, enjoy and have good flights.
